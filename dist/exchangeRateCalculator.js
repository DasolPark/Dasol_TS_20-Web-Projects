...
var topCurrency = document.getElementById('top-select');
var topAmount = document.getElementById('top-input');
var bottomCurrency = document.getElementById('bottom-select');
